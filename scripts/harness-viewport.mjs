...
createRoot(document.getElementById('root')!).render(
  <div className="min-h-screen bg-fundo">
    ...
    <main className="mx-auto max-w-4xl px-4 py-5 pb-16">
      <Inicio janela={[w.__ANALISE]} config={w.__CONFIG} jaRegistrados={w.__BILHETES} rascunhos={new Map()} onRegistrar={async () => {}} onApostarFaro={async () => {}} onMontarBilhete={async () => {}} onSalvarRascunho={() => {}} />
